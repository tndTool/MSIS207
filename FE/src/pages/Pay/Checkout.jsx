...
const Checkout = () => {
    ...
    return (
        <Helmet title="Checkout">
            ...
            {error ? <div className="checkout-fail">{error}</div> : null}
                        ...
                        <div className="checkout__left__box__main">
                            <div className="checkout__left__box__main__left">
                                ...
                                <select
                                    ...
                                    name="city"
                                    required
                                    onChange={(e) => setCity(e.target.selectedOptions[0].text)}
                                >
                                ...
                                <select
                                    name="ward"
                                    required
                                    onChange={(e) => setWard(e.target.selectedOptions[0].text)}
                                >
                                    <option value="0">Chọn</option>
                            ...
                            <div className="checkout__left__box__main__right">
                                ...
                                <select
                                    name="district"
                                    required
                                    onChange={(e) => setDistrict(e.target.selectedOptions[0].text)}
                                >
                                    <option value="0">Chọn</option>
